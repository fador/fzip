// fzip - zstd predefined FSE sequence decode tables (RFC 8878 4.1.1).
// Generated from the zstd v1.5.7 reference (lib/decompress/zstd_decompress_block.c).
// Field order matches ZSTD_seqSymbol: {nextState, nbAddBits, nbBits, baseValue}.
#pragma once
...
struct FseSeqSymbol {
    ...
    std::uint8_t  nb_add_bits;
    std::uint8_t  nb_bits;
    std::uint32_t base_value;
};

// Literal lengths, accuracy log 6 (64 states).
constexpr FseSeqSymbol kLLDefaultDTable[64] = {
...
// Offset codes, accuracy log 5 (32 states).
constexpr FseSeqSymbol kOFDefaultDTable[32] = {
...
// Match lengths, accuracy log 6 (64 states).
constexpr FseSeqSymbol kMLDefaultDTable[64] = {
